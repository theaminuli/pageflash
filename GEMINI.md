# Gemini AI Coding Guidelines for PageFlash

This document provides comprehensive coding guidelines and standards for AI-assisted development of the PageFlash WordPress plugin. These instructions ensure consistency, security, and code quality across the project when using AI coding assistants like Gemini.
...
This document is specifically designed for use with AI coding assistants like Google's Gemini to ensure they generate code that adheres to the PageFlash WordPress plugin's standards and best practices. It covers all essential aspects of WordPress plugin development including security, accessibility, coding standards, and modern JavaScript practices.

When using this guide with AI assistants:
- Reference specific sections for targeted guidance
- Use the checklist before finalizing code
- Validate generated code against these standards
- Always prioritize security and accessibility
- Follow WordPress and PSR-4 conventions strictly
