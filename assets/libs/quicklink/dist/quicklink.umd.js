! ( function ( e, n ) {
	...
	function s( e, r, o ) {
		const s = a( navigator.connection );
						...
						if ( ! i.has( e ) ) {
							return (
								...
								( r
									...
									: t )(
									new URL( e, location.href ).toString()
								)
							);
						}
					} )
	...
	function f( e, n ) {
		const r = a( navigator.connection );
		if ( r instanceof Error ) {
			return Promise.reject(
				new Error( 'Cannot prerender, ' + r.message )
			);
		}
		...
		for ( let t = 0, o = [].concat( e ); t < o.length; t += 1 ) {
			const f = o[ t ];
			if (
				window.location.origin !==
				new URL( f, window.location.href ).origin
			) {
				return Promise.reject(
				...
				function ( n ) {
					n.forEach( function ( n ) {
						if ( n.isIntersecting ) {
							...
							const o = p.indexOf( ( n = n.target ).href );
							o > -1 && p.splice( o );
						}
					} );
				},
