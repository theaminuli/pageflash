...
= 2.2.0 =
* Add PR #132 reference to changelog
* Merge pull request #132 from theaminulai/feat-add-7-general-features,-changelog-page,-and-dismissible-update-banner
* Feat: add 7 general features, changelog page, and dismissible update banner
