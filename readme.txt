...
* Add AGENTS.md and CLAUDE.md to .distignore and .gitattributes for export-ignore
...
* Initial plan
* Merge pull request #65 from theaminuli/copilot/create-claude-md
* Merge pull request #67 from theaminuli/copilot/create-gemini-md-file
* Create GEMINI.md with comprehensive coding guidelines
* Merge pull request #63 from theaminuli/copilot/create-agents-md-file
* Improve code readability in validatePositiveNumber example
* Fix code review feedback in AGENTS.md
* Create AGENTS.md with comprehensive coding standards
* Create CLAUDE.md with comprehensive coding standards
* Initial plan
* Initial plan
* Initial plan
* Merge pull request #61 from theaminuli/development
* Add GitHub Copilot instructions for PageFlash plugin
* Merge branch 'trunk' into development
* Merge branch 'trunk' into development
* Merge pull request #60 from theaminuli/copilot/create-copilot-instructions-md
* Clarify backward compatibility documentation requirement
* Address code review feedback: clarify PHP version requirement and improve PSR-4 example
* Create comprehensive copilot-instructions.md with all required standards
* Initial plan
* Fix
...
* Add:  DashboardData and Rest classes for PageFlash plugin REST functionality
